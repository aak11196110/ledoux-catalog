...
const INIT_PRODUCTS = [
  // ── HEPBURN 崁燈 ──
  { id:1,  model:"HB.D110-N", series:"HEPBURN", category:"崁燈", watt:"10W", lumen:"900lm", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥90", color:"白色/黑色", cutout:"Ø95mm", size:"Ø110×H95mm", install:"崁入式", cert:"CE", shipping:90, stdPrice:1200, projPrice:980, desc:"極簡主義崁燈，鋁合金一體成型，隱藏光源設計，適合精品住宅與商業空間。", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D110-White-300x300.png"], video:"", note:"" },
