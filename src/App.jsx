...
const INIT_PRODUCTS = [
  { id:1,  model:"HB.D110-N", series:"HEPBURN", category:"崁燈", watt:"10W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:1200, projPrice:980, desc:"極簡主義崁燈，鋁合金一體成型，隱藏光源設計", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D110-White-300x300.png"], video:"", note:"" },
  { id:2,  model:"HB.D120",   series:"HEPBURN", category:"崁燈", watt:"12W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:1380, projPrice:1120, desc:"Hepburn 系列經典款，優雅比例與高效能光源的完美結合", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D120-White-300x300.png"], video:"", note:"" },
  { id:3,  model:"HB.D130",   series:"HEPBURN", category:"崁燈", watt:"15W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:1580, projPrice:1280, desc:"15W 高效輸出，適合商業空間重點照明", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D130-240x300.jpg"], video:"", note:"" },
  { id:4,  model:"HB.D215",   series:"HEPBURN", category:"崁燈", watt:"20W", cct:"3000K / 4000K", beam:"36°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:1980, projPrice:1600, desc:"寬角度洗牆設計，均勻漫射光創造空間層次", images:["https://www.ledouxlight.com/wp-content/uploads/2023/01/Led-Recessed-Light-HB.D215-240x300.png"], video:"", note:"" },
  { id:5,  model:"HB.D230",   series:"HEPBURN", category:"崁燈", watt:"25W", cct:"3000K / 4000K", beam:"36°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:2280, projPrice:1860, desc:"25W 旗艦崁燈，適合高挑空間與精品陳列", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D230-240x300.jpg"], video:"", note:"" },
  { id:6,  model:"HB.D430",   series:"HEPBURN", category:"崁燈", watt:"30W", cct:"3000K / 4000K", beam:"36°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:2880, projPrice:2350, desc:"最大功率款，博物館與精品店首選", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-HB.D430-240x300.jpg"], video:"", note:"" },
  { id:7,  model:"NDB0306-C", series:"BLADE",   category:"崁燈", watt:"6W",  cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:780,  projPrice:630,  desc:"Blade 超薄系列，燈體極致纖薄，存在感歸零", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-NDB0306-C-240x300.jpg"], video:"", note:"" },
  { id:8,  model:"NDB0309-C", series:"BLADE",   category:"崁燈", watt:"9W",  cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:920,  projPrice:750,  desc:"9W 版本，天花板的隱形光源解決方案", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Light-NDB0309-C-240x300.jpg"], video:"", note:"" },
  { id:9,  model:"DFB0206-C", series:"METIS",   category:"崁燈", watt:"6W",  cct:"3000K / 4000K", beam:"40°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:1100, projPrice:890,  desc:"Metis 系列純鋁鍛造散熱，長壽命設計", images:["https://www.ledouxlight.com/wp-content/uploads/2022/12/Led-Recessed-Ceiling-Light-DFB0206-C-300x300.png"], video:"", note:"" },
  { id:10, model:"DFB0225-C", series:"METIS",   category:"崁燈", watt:"25W", cct:"3000K / 4000K", beam:"40°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:2680, projPrice:2180, desc:"25W 大功率版本，展示空間的最佳選擇", images:["https://www.ledouxlight.com/wp-content/uploads/2023/01/Led-Recessed-Ceiling-Light-DFB0225-C-1.png"], video:"", note:"" },
  { id:11, model:"TSU0506-C", series:"EOS",     category:"軌道燈", watt:"6W",  cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:980,  projPrice:800,  desc:"EOS 系列入門款，纖薄機身整合散熱模組", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/LED-Track-Light-TSU0506-C-240x300.jpg"], video:"", note:"" },
  { id:12, model:"TSU0515-C", series:"EOS",     category:"軌道燈", watt:"15W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1380, projPrice:1120, desc:"15W 精準投射，服飾與珠寶陳列專用", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/Led-Track-Light-TSU0515-White-240x300.jpg"], video:"", note:"" },
  { id:13, model:"TSU0823-C", series:"EOS",     category:"軌道燈", watt:"23W", cct:"3000K / 4000K", beam:"36°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1880, projPrice:1530, desc:"23W 大角度版，空間氛圍渲染首選", images:["https://www.ledouxlight.com/wp-content/uploads/2023/01/EOS-LED-Track-Light-TSU0823-C-1.png"], video:"", note:"" },
  { id:14, model:"HB.T130S",  series:"HEPBURN", category:"軌道燈", watt:"30W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥90", color:"白色", stdPrice:2480, projPrice:2020, desc:"Hepburn 軌道旗艦，30W 極致輸出", images:["https://www.ledouxlight.com/wp-content/uploads/2023/01/Led-Track-Light-HB.T130S-300x300.png"], video:"", note:"" },
  { id:15, model:"TSU0206-1", series:"THEIA",   category:"軌道燈", watt:"6W",  cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:980,  projPrice:800,  desc:"Theia 系列，180° 可調角度，靈活定向", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/TSU0206-1-241x300.png"], video:"", note:"" },
  { id:16, model:"TSU0212-1", series:"THEIA",   category:"軌道燈", watt:"12W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1280, projPrice:1040, desc:"12W 強化版，精品零售空間標準配置", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/TSU0212-1-241x300.png"], video:"", note:"" },
  { id:17, model:"DC.TS0110-C", series:"48V MAGNETIC", category:"磁吸系統", watt:"10W", cct:"3000K / 4000K", beam:"20°", voltage:"48V DC", cri:"Ra≥90", color:"白色", stdPrice:2380, projPrice:1940, desc:"48V 磁吸模組，無工具快速安裝，現代設計首選", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/48V-Led-Track-Light-DC.TS0110-C-241x300.jpg"], video:"", note:"" },
  { id:18, model:"DC.TS0120-C", series:"48V MAGNETIC", category:"磁吸系統", watt:"20W", cct:"3000K / 4000K", beam:"20°", voltage:"48V DC", cri:"Ra≥90", color:"白色", stdPrice:2980, projPrice:2430, desc:"20W 高輸出磁吸燈，藝廊與精品空間專用", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/48V-Led-Track-Light-DC.TS0120-C-241x300.jpg"], video:"", note:"" },
  { id:19, model:"DC.TS0130-C", series:"48V MAGNETIC", category:"磁吸系統", watt:"30W", cct:"3000K / 4000K", beam:"20°", voltage:"48V DC", cri:"Ra≥90", color:"白色", stdPrice:3580, projPrice:2920, desc:"30W 旗艦磁吸，最高端照明解決方案", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/48V-Led-Track-Light-DC.TS0130-C-241x300.jpg"], video:"", note:"" },
  { id:20, model:"DC.TS0206-C", series:"48V MAGNETIC", category:"磁吸系統", watt:"6W",  cct:"3000K / 4000K", beam:"20°", voltage:"48V DC", cri:"Ra≥90", color:"白色", stdPrice:1980, projPrice:1620, desc:"入門磁吸款，系統彈性配置的理想起點", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/48V-Led-Track-Light-DC.TS0206-C--241x300.jpg"], video:"", note:"" },
  { id:21, model:"CSU0515-C",   series:"EOS",   category:"吸頂燈", watt:"15W", cct:"3000K / 4000K", beam:"36°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1580, projPrice:1290, desc:"EOS 吸頂款，無需開孔直接安裝", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/Surface-Mount-CSU0510-C-240x300.jpg"], video:"", note:"" },
  { id:22, model:"CSA0206-1",   series:"THEIA", category:"吸頂燈", watt:"6W",  cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1080, projPrice:880,  desc:"Theia 吸頂 6W，住宅走廊首選", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/CSA0206-1-241x300.png"], video:"", note:"" },
  { id:23, model:"CSA0212-1",   series:"THEIA", category:"吸頂燈", watt:"12W", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:1380, projPrice:1120, desc:"12W 加強版，商業走廊與接待廳適用", images:["https://www.ledouxlight.com/wp-content/uploads/2022/05/CSA0212-1-241x300.png"], video:"", note:"" },
];

const COMPANY = {
  name: "台灣諾科照明有限公司",
  eng: "Ledoux Lighting Taiwan Co., Ltd.",
  addr: "台灣",
  tel: "",
  fax: "",
  email: "info@ledouxlight.com",
  taxId: "",
};
...
.cart-btn { position:relative; background:none; border:none; color:#8a7a6a; cursor:pointer; padding:4px; font-size:20px; display:flex; align-items:center; }
.cart-btn:hover { color:var(--gold); }
.cart-count { position:absolute; top:-4px; right:-4px; background:var(--gold); color:var(--black); font-size:8px; border-radius:50%; width:16px; height:16px; display:flex; align-items:center; justify-content:center; font-weight:500; }
...
.sm-sub { display:flex; align-items:center; padding:9px 24px 9px 40px; font-size:10px; letter-spacing:1px; color:#4a4038; cursor:pointer; transition:all .15s; }
...
.btn-add-cart { flex:1; padding:12px; background:var(--black); border:none; color:var(--ivory); font-family:'Noto Sans TC',sans-serif; font-size:10px; letter-spacing:2px; cursor:pointer; transition:background .2s; }
...
/* TRANSFER BLOCK */
.transfer-block { background:#f4efe8; border:1px solid var(--bdr2); padding:20px; margin-top:24px; }
...
.cat-card { border:1px solid var(--bdr2); padding:24px; cursor:pointer; transition:all .2s; display:flex; flex-direction:column; align-items:center; text-align:center; gap:12px; }
...
/* PRINT (PDF) styles */
@media print {
  body > *:not(#pdf-print) { display:none !important; }
...
function generatePDF({ cart, projectName, customer, useProj }) {
  ...
  const rows = cart.map((item, i) => {
    ...
    return `
      <tr>
        <td>${i+1}</td>
        <td><b>${item.product.model}</b><br><span style="font-size:10px;color:#666">${item.product.series}</span></td>
        <td>${item.product.watt||""}</td>
        <td>${item.product.beam||""}</td>
        <td>${item.product.cct||""}</td>
        <td>${item.product.voltage||""}</td>
        <td>${item.product.cri||""}</td>
        <td>${item.product.color||""}</td>
        <td style="text-align:center">${item.qty}</td>
        <td>組</td>
        <td style="text-align:right">NT$ ${price.toLocaleString()}</td>
        <td style="text-align:right">NT$ ${subtotal.toLocaleString()}</td>
        <td style="font-size:10px;color:#666">${item.product.note||""}</td>
      </tr>`;
  }).join("");

  const subtotal = cart.reduce((s, it) => {
    const p = useProj ? it.product.projPrice : it.product.stdPrice;
    return s + p * it.qty;
  }, 0);
...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  body { font-family:"Noto Sans TC","Microsoft JhengHei",sans-serif; font-size:12px; color:#111; background:#fff; padding:30px 40px; }
  .hd { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:24px; border-bottom:2px solid #111; padding-bottom:16px; }
  .co-name { font-size:20px; font-weight:700; letter-spacing:2px; }
  .co-sub { font-size:10px; color:#555; margin-top:3px; }
  .co-info { font-size:10px; color:#555; line-height:1.8; text-align:right; }
  .doc-title { text-align:center; font-size:18px; font-weight:700; letter-spacing:4px; margin-bottom:20px; }
  .meta-grid { display:grid; grid-template-columns:1fr 1fr; gap:0; border:1px solid #ccc; margin-bottom:20px; }
  .meta-cell { padding:8px 12px; border-bottom:1px solid #ccc; }
  .meta-cell:nth-child(odd) { border-right:1px solid #ccc; }
  .meta-label { font-size:9px; color:#666; letter-spacing:1px; text-transform:uppercase; }
  .meta-val { font-size:12px; font-weight:500; margin-top:2px; }
  table { width:100%; border-collapse:collapse; margin-bottom:16px; font-size:11px; }
  th { background:#111; color:#fff; padding:7px 8px; text-align:left; font-size:9px; letter-spacing:1px; }
  td { padding:7px 8px; border-bottom:1px solid #e0e0e0; vertical-align:top; }
  tr:nth-child(even) td { background:#fafafa; }
  .total-block { display:flex; justify-content:flex-end; margin-bottom:20px; }
  .total-table { border:1px solid #ccc; min-width:260px; }
  .tt-row { display:flex; justify-content:space-between; padding:8px 14px; border-bottom:1px solid #eee; }
  .tt-row.bold { font-weight:700; font-size:14px; background:#f5f5f5; }
  .tt-lbl { color:#555; }
  .notes { border:1px solid #ccc; padding:14px; margin-bottom:20px; font-size:10px; line-height:2; color:#444; }
  .notes b { color:#111; }
  .sign-row { display:grid; grid-template-columns:1fr 1fr 1fr; gap:24px; margin-top:32px; }
  .sign-box { border-top:1px solid #ccc; padding-top:8px; font-size:10px; color:#666; }
  .footer { margin-top:24px; border-top:1px solid #ccc; padding-top:12px; font-size:9px; color:#999; text-align:center; }
</style>
</head>
<body>
<div class="hd">
  <div>
    ...
    <div class="co-sub">${COMPANY.eng}</div>
  </div>
  <div class="co-info">
...
<div class="meta-grid">
  <div class="meta-cell"><div class="meta-label">報價單號</div><div class="meta-val">${quoteNo}</div></div>
  <div class="meta-cell"><div class="meta-label">報價日期</div><div class="meta-val">${dateStr}</div></div>
  <div class="meta-cell"><div class="meta-label">客戶公司</div><div class="meta-val">${customer.company||"—"}</div></div>
  <div class="meta-cell"><div class="meta-label">聯絡人</div><div class="meta-val">${customer.name||"—"}${customer.position?" · "+customer.position:""}</div></div>
  <div class="meta-cell"><div class="meta-label">案名</div><div class="meta-val">${projectName}</div></div>
  <div class="meta-cell"><div class="meta-label">有效期限</div><div class="meta-val">${dateStr} 起 30 天內</div></div>
</div>
<table>
  <thead>
    <tr>
      <th>#</th><th>型號／系列</th><th>瓦數</th><th>角度</th><th>色溫</th><th>電壓</th><th>演色性</th><th>顏色</th>
      <th style="text-align:center">數量</th><th>單位</th><th style="text-align:right">單價</th><th style="text-align:right">金額</th><th>備註</th>
    </tr>
  </thead>
  <tbody>${rows}</tbody>
</table>
<div class="total-block">
  <div class="total-table">
    <div class="tt-row"><span class="tt-lbl">小計</span><span>NT$ ${subtotal.toLocaleString()}</span></div>
    <div class="tt-row"><span class="tt-lbl">稅金（5%）</span><span>NT$ ${tax.toLocaleString()}</span></div>
    <div class="tt-row bold"><span class="tt-lbl">總計</span><span>NT$ ${total.toLocaleString()}</span></div>
  </div>
</div>
<div class="notes">
  <b>備　註：</b><br>
  A. 交期如遇天災不可抗力因素，得予展延，不計入違約。<br>
  B. 訂單未滿 NT$3,000 者，運費由買方自付。<br>
  C. 保固期限：室內產品 3 年；戶外產品 2 年（人為損壞不在保固範圍內）。<br>
  D. 本報價單有效期限為開立日起 30 天，請於期限內回簽確認，逾期恕不保留。
</div>
<div class="sign-row">
  <div class="sign-box">業務代表簽章</div>
  <div class="sign-box">客戶確認簽章</div>
  <div class="sign-box">日期</div>
</div>
<div class="footer">${COMPANY.name} · 本報價單僅供核可客戶使用，請勿外流</div>
</body>
</html>`;
  ...
  a.href = url;
  a.download = `報價單_${projectName}_${quoteNo}.html`;
  a.click();
...
const cats = (products) => ["全部", ...new Set(products.map(p => p.category))];

function Carousel({ images }) {
  const [idx, setIdx] = useState(0);
  const imgs = images?.filter(Boolean) || [];
  if (imgs.length === 0) return <div className="carousel" style={{display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontSize:64,color:"var(--bdr)"}}>◎</span></div>;
  return (
    <div className="carousel">
      ...
      {imgs.length > 1 && <>
        <button className="carousel-prev" onClick={()=>setIdx(i=>(i-1+imgs.length)%imgs.length)}>‹</button>
        <button className="carousel-next" onClick={()=>setIdx(i=>(i+1)%imgs.length)}>›</button>
...
export default function App() {
  ...
  const [catalogs, setCatalogs] = useState([]); // { id, name, url, size }
  ...
  const [newProd, setNewProd] = useState({ model:"", series:"", category:"崁燈", watt:"", cct:"3000K / 4000K", beam:"24°", voltage:"220V", cri:"Ra≥80", color:"白色", stdPrice:"", projPrice:"", desc:"", images:"", video:"", note:"" });
  ...
  const cartTotal = cart.reduce((s,i)=>{
    const p = isVip ? i.product.projPrice : i.product.stdPrice;
    return s + p * i.qty;
  }, 0);
  ...
  const doAddProd = () => {
    ...
    setProducts(x=>[...x,{...newProd,id:Date.now(),stdPrice:Number(newProd.stdPrice),projPrice:Number(newProd.projPrice),images:imgs}]);
    setNewProd({model:"",series:"",category:"崁燈",watt:"",cct:"3000K / 4000K",beam:"24°",voltage:"220V",cri:"Ra≥80",color:"白色",stdPrice:"",projPrice:"",desc:"",images:"",video:"",note:""});
    setShowAddProd(false); toast$("✓ 產品已新增");
  };

  const startEdit = (p) => {
    setEditProd({ ...p, images: (p.images||[]).join("\n") });
  };
  const saveEdit = () => {
    const imgs = editProd.images ? editProd.images.split("\n").map(s=>s.trim()).filter(Boolean) : [];
    setProducts(x=>x.map(p=>p.id===editProd.id?{...editProd,stdPrice:Number(editProd.stdPrice),projPrice:Number(editProd.projPrice),images:imgs}:p));
  ...
  const handleGenPDF = () => {
    ...
    generatePDF({ cart, projectName, customer: { company:user.company, name:user.name, position:user.position }, useProj:isVip });
    toast$("✓ 報價單已下載（HTML 格式，用瀏覽器列印為 PDF）");
  };

  // ── TRANSFER ──
  const handleTransfer = () => {
    if (!transferF.amount || !transferF.account) { toast$("請填寫轉帳金額和帳戶尾數"); return; }
    setTransferDone(true);
    toast$("✓ 轉帳通知已送出，專員將盡快確認");
  };
  ...
  const handleFiles = (files) => {
    Array.from(files).forEach(f=>{
      ...
      setCatalogs(c=>[...c,{id:Date.now()+Math.random(),name:f.name,url,size:Math.round(f.size/1024)+"KB"}]);
    });
    toast$("✓ 型錄已上傳");
  };
  ...
  const productCategories = ["崁燈","軌道燈","磁吸系統","吸頂燈"];
    ...
    <div className="app">
      ...
      <div className={`sidemenu ${menuOpen?"open":""}`}>
        ...
        <div className="sm-nav">
          ...
          <div className="sm-section" style={{marginTop:8}}>產品分類</div>
          {productCategories.map(c=>(
            <div key={c} className={`sm-sub ${page==="catalog"&&cat===c?"on":""}`} onClick={()=>{setPage("catalog");setCat(c);setMenuOpen(false);}}>
      ...
      <div className={`cart-panel ${cartOpen?"open":""}`}>
        ...
        <div className="cp-body">
          {cart.length===0?(
            ...
            return (
              <div key={item.product.id} className="ci-row">
                <div className="ci-img">
                  {item.product.images?.[0]?<img src={item.product.images[0]} alt=""/>:<span style={{fontSize:24,color:"var(--bdr)"}}>◎</span>}
                </div>
          ...
          {cart.length>0&&(
            <div className="transfer-block">
              ...
              {!transferDone?(
                <>
                  <div className="tb-hint">如已完成匯款，請填寫以下資訊，專人將盡快確認收款並安排後續。</div>
                ...
                <div style={{color:"var(--green)",fontSize:12,lineHeight:1.8}}>
                  ✓ 轉帳通知已送出<br/>金額：NT$ {transferF.amount}・末 5 碼：{transferF.account}<br/>
                  <span style={{color:"var(--muted)"}}>專員將於確認後與您聯繫</span>
                </div>
              )}
            </div>
          )}
        ...
        <div className="cp-foot">
          ...
          <button className="btn-gen-pdf" onClick={handleGenPDF} disabled={cart.length===0||!projectName.trim()}>下載報價單 PDF</button>
        </div>
      </div>
      ...
      <div className="content">
        ...
        {page==="catalog"&&<>
          <div className="phead">
            <div>
              ...
              <div className="psub">{isVip?"顯示標準價與專案價":"顯示標準售價，如需專案報價請洽業務"}</div>
            </div>
            <div className="pcount">{filtered.length} 件商品</div>
          </div>
          <div className="catbar">
            {cats(products).map(c=><button key={c} className={`catbtn ${cat===c?"on":""}`} onClick={()=>setCat(c)}>{c}</button>)}
          </div>
          <div className="pgrid">
            {filtered.map(p=>(
        ...
        {page==="inquiry"&&<>
          ...
          {cart.length===0?(
            <div className="empty">— 尚未加入任何產品，請至產品目錄選購 —</div>
          ):(
            <>
              ...
              <div style={{maxWidth:480}}>
                <div className="cp-project" style={{marginBottom:16}}>
                ...
                <div style={{display:"flex",justifyContent:"space-between",marginBottom:16,fontSize:12,color:"var(--muted)"}}>
                  <span>{isVip?"專案價小計":"標準價小計"}</span>
                  <strong style={{color:"var(--black)",fontFamily:"'Cormorant Garamond',serif",fontSize:20}}>NT$ {cartTotal.toLocaleString()}</strong>
                </div>
                <button className="btn-gen-pdf" onClick={handleGenPDF} disabled={!projectName.trim()}>下載報價單 HTML（可列印為 PDF）</button>

                <div className="transfer-block" style={{marginTop:24}}>
                  <div className="tb-title">💳 轉帳通知</div>
                  {!transferDone?(
                    <>
                    ...
                    <div style={{color:"var(--green)",fontSize:12,lineHeight:1.8}}>
                      ✓ 轉帳通知已送出 · NT$ {transferF.amount} · 末 5 碼：{transferF.account}<br/>
                      <span style={{color:"var(--muted)"}}>專員將於確認後與您聯繫</span>
                    </div>
                  )}
                </div>
        ...
        {page==="catalogs"&&<>
          <div className="phead">
            <div><div className="ptitle">電子型錄</div><div className="psub">下載最新產品型錄</div></div>
            {user.role==="admin"&&<button className="btn-upload" onClick={()=>fileInputRef.current?.click()}>＋ 上傳型錄</button>}
          </div>
          {user.role==="admin"&&(
            <div className={`upload-area ${dragOver?"drag":""}`}
              ...
              <div className="upload-hint">支援 PDF、PNG、JPG 等格式</div>
            </div>
          )}
          ...
          {catalogs.length===0?(
            <div className="empty">— 尚無型錄，{user.role==="admin"?"請上傳型錄檔案":"請洽業務索取" } —</div>
          ):(
            <div className="catalog-grid">
              {catalogs.map(c=>(
                <a key={c.id} href={c.url} download={c.name} className="cat-card" style={{textDecoration:"none",color:"inherit"}}>
                  ...
                  <div className="fgrid">
                    ...
                    <div className="ff full"><label>報價權限</label>
                      <select value={approveF.role} onChange={e=>setApproveF(p=>({...p,role:e.target.value}))}>
                        ...
                        <option value="vip">VIP 客戶（可見專案價）</option>
        ...
        {page==="products"&&user.role==="admin"&&<>
          ...
          {showAddProd&&(
            <div className="form-panel">
              ...
              <div className="fgrid">
                ...
                <div className="ff"><label>電壓</label><input value={newProd.voltage} onChange={e=>setNewProd(p=>({...p,voltage:e.target.value}))} placeholder="220V"/></div>
                <div className="ff"><label>演色性</label><input value={newProd.cri} onChange={e=>setNewProd(p=>({...p,cri:e.target.value}))} placeholder="Ra≥90"/></div>
                <div className="ff"><label>顏色</label><input value={newProd.color} onChange={e=>setNewProd(p=>({...p,color:e.target.value}))} placeholder="白色"/></div>
                ...
                <div className="ff"><label>專案價（NT$）</label><input type="number" value={newProd.projPrice} onChange={e=>setNewProd(p=>({...p,projPrice:e.target.value}))}/></div>
          ...
          {editProd&&(
            <div className="form-panel" style={{background:"#f0ebe2"}}>
              ...
              <div className="fgrid">
                <div className="ff"><label>型號</label><input value={editProd.model} onChange={e=>setEditProd(p=>({...p,model:e.target.value}))}/></div>
                <div className="ff"><label>系列</label><input value={editProd.series} onChange={e=>setEditProd(p=>({...p,series:e.target.value}))}/></div>
                ...
                <div className="ff"><label>瓦數</label><input value={editProd.watt} onChange={e=>setEditProd(p=>({...p,watt:e.target.value}))}/></div>
                <div className="ff"><label>色溫</label><input value={editProd.cct} onChange={e=>setEditProd(p=>({...p,cct:e.target.value}))}/></div>
                <div className="ff"><label>光束角</label><input value={editProd.beam} onChange={e=>setEditProd(p=>({...p,beam:e.target.value}))}/></div>
                <div className="ff"><label>電壓</label><input value={editProd.voltage||""} onChange={e=>setEditProd(p=>({...p,voltage:e.target.value}))}/></div>
                <div className="ff"><label>演色性</label><input value={editProd.cri||""} onChange={e=>setEditProd(p=>({...p,cri:e.target.value}))}/></div>
                <div className="ff"><label>顏色</label><input value={editProd.color||""} onChange={e=>setEditProd(p=>({...p,color:e.target.value}))}/></div>
                <div className="ff"><label>標準價（NT$）</label><input type="number" value={editProd.stdPrice} onChange={e=>setEditProd(p=>({...p,stdPrice:e.target.value}))}/></div>
                <div className="ff"><label>專案價（NT$）</label><input type="number" value={editProd.projPrice} onChange={e=>setEditProd(p=>({...p,projPrice:e.target.value}))}/></div>
          ...
          <div className="tbl-wrap"><table>
            <thead><tr><th>型號</th><th>系列</th><th>分類</th><th>瓦數</th><th>標準價</th><th>專案價</th><th>操作</th></tr></thead>
        ...
        <div className="drawer" onClick={e=>e.stopPropagation()}>
          ...
          <div className="drawer-body">
            ...
            <div className="spec-grid">
              ...
              <div className="spec-item"><div className="spec-label">電壓</div><div className="spec-val">{selProd.voltage||"—"}</div></div>
              <div className="spec-item"><div className="spec-label">演色性</div><div className="spec-val">{selProd.cri||"—"}</div></div>
              <div className="spec-item"><div className="spec-label">顏色</div><div className="spec-val">{selProd.color||"—"}</div></div>
            </div>
            {selProd.video&&(
              <div className="drawer-video">
                <iframe src={selProd.video} title="產品影片" allowFullScreen/>
              </div>
            )}
            {selProd.note&&<div className="drawer-note">📌 {selProd.note}</div>}
            <div className="price-block">
              <div className="pb-item">
                <div className="pb-label">標準售價</div>
                <div className="pb-val">NT$ {selProd.stdPrice?.toLocaleString()}</div>
              </div>
              {isVip&&<div className="pb-item">
                <div className="pb-label">專案價</div>
...
function btn_add2_cls() { return "btn-add2"; }
